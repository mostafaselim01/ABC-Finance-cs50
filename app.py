...
def register():
    ...
    # Check if the user do mistakes or not in entering data
    if not username:
    ...
    # Using try and except to insert to database and avoid tracebacks
    try:
        new_user = db.execute("INSERT INTO users(username, hash) VALUES(?, ?)", username, hash)
    except:
        return apology("Username already exists")

    # start session for the user to already use the website
